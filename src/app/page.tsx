              ...
              <div className="container mx-auto px-4 pt-3 mt-4 bg-white rounded-2xl">
                <div className="px-8 flex flex-row">
                  <p className="pr-16 max-w-lg pt-24">
                    ...
                    commitment with an environmental impact. Join us in shaping
                ...
                <div className="pb-8 flex flex-row rounded-lg">
                  ...
                  <div className="bg-green-800 px-8 mr-8 pt-8 text-white">
                    ...
                    <p className="pb-4">
                      ...
                      revolutionizing energy generation and combine climate
                      change through renewable technologies
                    </p>
                    <p className="pb-4">
                      Total Investment Needed: 250,000 Naira
                    </p>
                    <Link
                ...
                <div className="pb-8 flex flex-row rounded-lg">
                  ...
                  <div className="bg-green-800 px-8 mr-8 pt-8 text-white">
                    ...
                    <p className="pb-4">
                      Our Project is dedicated to creating technologically
                      advanced vertical farms that produce fresh, nutritious
                      products while minimizing environmental effects
                    </p>
                    <p className="pb-4">
                      Total Investment Needed: 1,250,000 Naira
                    </p>
                    <Link
                      className="text-black bg-emerald-300 p-1.5 rounded-md"
            ...
            <div className="bg-slate-100 h-fit w-full py-9">
              <div className="container mx-auto grid place-items-center mb-8">
                ...
                <p className="text-justify mx-28">
                  ...
                  sustainable projects. Whether you're an investor seeking
                  financial growth or a borrower looking to fund your
                  eco-friendly initiatives, we have options tailored to your
                  goals!
                </p>
              </div>
              <div className="container mx-auto bg-white rounded-lg p-8">
                <p className="text-2xl underline mb-2 tracking-wider">
                ...
                <div className="flex flex-row gap-x-10">
                  ...
                  <p className="pl-10 text-justify">
                    Investing in Sustainable Projects with Greenvestor goes
                    beyond Financial Gains - It's about driving Positive Change
                ...
                <div className="flex flex-row gap-x-11 pb-4">
                  ...
                  <p className="pl-24 text-justify">
                    Take the next step towards realizing your eco-friendly
                    project by connecting with Investors who Believe in your
                    Vision!
                  </p>
                </div>
                <Link
                  className="grid place-items-center bg-green-400 mx-96 rounded-lg p-2"
                  href="/about"
                >
                  Learn More
                </Link>
            ...
            <div className="mt-12 container mx-auto pl-8">
              ...
              <div className="flex flex-row justify-items-end ml-96 pl-72">
                <div className="place-items-end flex flex-col">
                  ...
                  <Link className="mb-3" href="/projects">
                    Projects
                  </Link>
                  <Link className="mb-3" href="/contact">
                    Contact Us
                  </Link>
                </div>
